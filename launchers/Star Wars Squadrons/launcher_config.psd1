@{
    ...
    USB_DEVICES = @{
        ...
        "Buttkicker Pro" = "VID_2833&PID_0186"
    }
    ...
    REQUIRED_PROCESSES = @{
        "bk-connect" = "C:\Program Files\ButtKicker\connect\bk-connect.exe"
    ...
    DEFAULT_AUDIO_DEVICE = "ButtKicker Input"
    DEFAULT_OPENXR_RUNTIME = "pimax"  # Options: "pimax", "oculus", or "" for none
    EXECUTABLE_PATH = "C:\Windows\System32\cmd.exe"
    ARGUMENTS = @(
         '/c start "" /affinity FF  "C:\Program Files (x86)\Steam\steamapps\common\STAR WARS Squadrons\starwarssquadrons.exe"'
    )
